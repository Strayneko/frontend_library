...
@section('content')
    ...
    <h1 class="my-4">Tambah data buku</h1>
    <form action="" method="post" class="col-md-5" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-3">
            <input type="text" id="book_language" name="book_language" class="form-control"
                value="{{ old('book_language') }}" required />
        ...
        <div class="form-outline mb-3">
            <input type="number" maxlength="9999" id="total_pages" name="total_pages" class="form-control"
                value="{{ old('total_pages') }}" required />
            <label class="form-label" for="total_pages">Jumlah Halaman</label>
        </div>

        <div class="form-outline mb-3">
            <textarea type="text" id="description" name="description" class="form-control" required>{{ old('description') }}</textarea>
